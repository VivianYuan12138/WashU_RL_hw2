...
class HistoryPreprocessor(Preprocessor):
    ...
    def process_state_for_network(self, state):
        ...
        if len(self.state_buffer) < self.history_length:
            for _ in range(self.history_length - len(self.state_buffer)):
                self.state_buffer.append(np.zeros_like(state))
...
class AtariPreprocessor(Preprocessor):
    ...
    def process_state_for_memory(self, state):
        ...
        return Preprocessor.process_state_for_memory(self, state)
    ...
    def process_state_for_network(self, state):
        ...
        """
        return Preprocessor.process_state_for_network(self, state)
    ...
    def process_batch(self, samples):
        ...
        """
        return Preprocessor.process_batch(self, samples)
...
class PreprocessorSequence(Preprocessor):
    ...
    def process_state_for_network(self, state):
        """Process state through each preprocessor in sequence."""
    ...
    def process_batch(self, samples):
        """Process batch through each preprocessor in sequence."""
        for preprocessor in self.preprocessors:
            samples = preprocessor.process_batch(samples)
        return samples

    def process_reward(self, reward):
        """Process reward through each preprocessor in sequence."""
        for preprocessor in self.preprocessors:
